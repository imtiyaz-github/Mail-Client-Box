...
const SignUp = () => {
  ...
  //signup function to create new user in firebase database and store the data locally as well using redux
  ...
  const submitHandler = async (e) => {
    ...
    if (isLogin) {
      url =
        'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDoZRMU1-6UtEcvs5ANvmh8Vvu3mszaJAU'
       
    } else {
  
      url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDoZRMU1-6UtEcvs5ANvmh8Vvu3mszaJAU";
    }
